...
export const NA_LOCALES = ['en-US', 'en-CA', 'en-MX', 'en-JP', 'en-KR', 'en-AU', 'en-TW', 'en-NZ', 'en-HK', 'en-MY', 'en-TH', 'en-PH']
export const EU_LOCALES = ['en-GB', 'en-NO', 'en-NL', 'en-DE', 'en-FR', 'en-IT', 'en-ES', 'en-SE', 'en-DK', 'en-FI', 'en-BE', 'en-AT', 'en-CH', 'en-IE', 'en-LU', 'en-PT', 'en-IS', 'en-SI', 'en-EE', 'en-LV', 'en-LT', 'en-CZ', 'en-SK', 'en-HU', 'en-PL', 'en-HR', 'en-BG', 'en-RO', 'en-GR', 'en-CY', 'en-MT', 'en-AE', 'en-IL', 'en-ZA']
...
export const TESLA_REGIONS: Record<TeslaRegion, TeslaRegionInfo> = {
  na: {
    ...
    countries: ['US', 'CA', 'MX', 'PR', 'JP', 'KR', 'AU', 'TW', 'NZ', 'HK', 'MO', 'MY', 'TH', 'PH'],
    description: 'United States, Canada, Mexico, Japan, Korea, Australia, and other Asia-Pacific countries'
  },
  eu: {
    code: 'eu', 
    name: 'Europe, Middle East & Africa',
    apiUrl: 'https://fleet-api.prd.eu.vn.cloud.tesla.com',
    countries: ['GB', 'NO', 'NL', 'DE', 'FR', 'IT', 'ES', 'SE', 'DK', 'FI', 'BE', 'AT', 'CH', 'IE', 'LU', 'PT', 'IS', 'SI', 'EE', 'LV', 'LT', 'CZ', 'SK', 'HU', 'PL', 'HR', 'BG', 'RO', 'GR', 'CY', 'MT', 'AE', 'IL', 'ZA'],
...
export function detectTeslaRegionForLocale(): TeslaRegion {
  ...
  if (typeof window !== 'undefined') {
    try {
      ...
      // European locales
      const europeanLocales = ['de', 'fr', 'it', 'es', 'nl', 'sv', 'da', 'no', 'fi', 'pl', 'pt', 'cs', 'sk', 'hu', 'hr', 'bg', 'ro', 'el', 'et', 'lv', 'lt', 'sl', 'mt', 'ga', 'eu', 'ca', 'gl']
      
      if (europeanLocales.some(lang => locale.toLowerCase().startsWith(lang))) {
        return 'eu'
      }
      
      // UK specific
      if (locale.toLowerCase().includes('gb') || locale.toLowerCase().includes('uk')) {
        return 'eu'
      }
