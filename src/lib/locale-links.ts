 ...
 */
export function createLocalePath(path: string, locale: string = defaultLocale): string {
...
export function getLocaleLinks(currentLocale: string) {
  return {
    ...
    privacy: createLocalePath('privacy', currentLocale),
 ...
 */
export function switchLocale(currentPath: string, currentLocale: string, newLocale: string): string {
